...
**Dystrybucja** to funkcjonał liniowy $T$ określony na $\mathbb{R}$, któr spełnia warunek:

$$\int_{\mathbb{R}} T \cdot f_n = \int_{\mathbb{R}} T \cdot f \iff f_n \to f$$

Każda całkowalna i określona funkcja na $\mathbb{R}$ jest dystrybucją. Zachodzi też relacja:

$$T_n \to T \iff \int_{\mathbb{R}} T_n \cdot f \to \int_{\mathbb{R}} T \cdot f$$
