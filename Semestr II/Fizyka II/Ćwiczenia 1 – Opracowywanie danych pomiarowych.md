## Błąd pomiaru
Zakładając, że istnieje rzeczywista wartość zjawiska, które mierzymy, błędem pomiaru tegoż zjawiska nazywamy różnicę między wielkością zmierzoną w eksperymencie a tą faktyczną:

$$\Delta x = x - x_0$$

Gdzie $\Delta x$ to błąd pomiaru, $x$ to wartość zmierzona, a $x_0$ to wartość rzeczywista.
