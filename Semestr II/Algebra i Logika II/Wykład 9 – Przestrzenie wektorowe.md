...
* **Dodawanie i odejmowanie wektorów:** $$\mathbf{a} \pm \mathbf{b} = (a_1 \pm b_1, a_2 \pm b_2, \dots, a_n \pm b_n)$$
* **Mnożenie wektora przez skalar:** $$\alpha \cdot \mathbf{a} = (\alpha a_1, \alpha a_2, \dots, \alpha a_n)$$
* **Norma wektora:** $$\|\mathbf{a}\| = \sqrt{a_1^2 + a_2^2 + \dots + a_n^2}$$
* **Iloczyn skalarny:** $$\mathbf{a} \cdot \mathbf{b} = (a_1 b_1, a_2 b_2, \dots, a_n b_n)$$
* **Iloczyn wektorowy (tylko w $\mathbb{R}^3$):** $$\mathbf{a} \times \mathbf{b} = (a_2 b_3 - a_3 b_2, a_3 b_1 - a_1 b_3, a_1 b_2 - a_2 b_1)$$
## Wektor zerowy
...
### Suma prosta
Przestrzeń $V$ nazywamy sumą prostą podprzestrzeni $U$ i $W$, jeżeli spełnione są następujące warunki:$$V = U + W$$$$U \cap W = \{0\}$$Jeżeli $V$ jest sumą prostą $U$ i $W$, zapisujemy to jako $V = U \oplus W$.
