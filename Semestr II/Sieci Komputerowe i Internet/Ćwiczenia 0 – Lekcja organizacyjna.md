...
| Sala       | RMS 418                                                                                                          |
| Platforma  | [https://platforma.polsl.pl/rms/enrol/index.php?id=1524](https://platforma.polsl.pl/rms/enrol/index.php?id=1524) |

| Tytuł                                               | Autor                   |
| --------------------------------------------------- | ----------------------- |
| *Zostań administratorem sieci komputerowych Cisco*  | Adam Józefiok           |
| *Akademia sieci Cisco. CCNA Exploration. Semestr 1* | A. M. Dye, N. McDonald  |
| *Akademia sieci Cisco. CCNA Exploration. Semestr 2* | R. Graziani, A. Johnson |
| *Akademia sieci Cisco. CCNA Exploration. Semestr 3* | W. Lewis                |
| *Sieci komputerowe i intersieci*                    | D. Comer                |
| *Biblia TCP/IP*                                     | opracowanie zbiorowe    |

| Nazwa programu      | Link                                                                                                                      |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| Cisco Packet Tracer | [www.netacad.com/about-networking-academy/packet-tracer/](http://www.netacad.com/about-networking-academy/packet-tracer/) |
| Wireshark           | [https://www.wireshark.org](https://www.wireshark.org)                                                                    |
| Oracle VirutalBox   | [https://www.virtualbox.org](https://www.virtualbox.org)                                                                  |
...
## Tematyka przedmiotu:
1. Budowa małej i prostej sieci komputerowej
2. Warstwa transportowa
3. Adresowanie IPv4 / IPv6
4. Wartwa sieci
5. Ethernet
6. Podział na sieci i podsieci