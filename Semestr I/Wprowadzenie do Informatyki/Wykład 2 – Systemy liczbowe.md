...
Operację odejmowania dwóch nieujemnych liczb można w systemach liczbowych zdefiniować jako operację dodawania $p$-tego uzupełnienia liczby odejmowanej:

$$X - Y = X + \overline{\overline{Y}}$$
