...
Fakt ten możemy łatwo udowodnić korzystając z własności silni. Niech $n\in\mathbb{N}$. Możemy zauważyć, że liczba $(n+1)!$ jest podzielna przez każdą z liczb $d\in\{2, 3, 4, 5, \cdots,n−1,n, n+1\}$. Możemy skonstruować ciąg kolejnych liczb:
