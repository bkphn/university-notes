...
\end{cases}$$
## Ciąg Fibonacciego
Ciąg Fibonacciego, zaproponowany w 1202 roku przez Leonarda z Pizy określony był wzorem rekurencyjnym: $$\begin{cases}
...
Wzór jawny ciągu Catalana ma postać: $$C_{n}=\binom{2n}{n}\frac{1}{n+1}$$Ciąg ten w OEIS jest opisany jako ciąg [ciąg A000108](https://oeis.org/A000108).

## Funkcja 91 McCarthy'ego
Funkcja 91 McCarthy'ego nazywana czasem po prostu funkcją McCarthy'ego została zaproponowana w 1970 roku przez informatyka Johna McCarthy'ego. Funkcję tą definiuje się wzorem: $$M(n)=\begin{cases}
...
$$a_{n}=Aa_{n-1}+Ba_{n-2}$$gdzie $n\geq n_0$, $A,B\in\mathbb{C}, B\neq 0$.

**Równaniem charakterystycznym** dla $a_n=Aa_{n−1}+Ba_{n−2}$  nazywamy równanie w postaci:
$$r^2−Ar−B=0$$
Wielomian $r^2−Ar−B$ nazywamy wielomianem charakterystycznym zależności $$a_n=Aa_{n−1}+Ba_{n−2}$$
