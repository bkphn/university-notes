...
Zasada plastra miodu, mówi że iloczyn trzech niestykających się elementów plastra miodu jest równy iloczynowi trzech pozostałych. W ujęciu matematycznym zasadę plastra miodu możemy zapisać jako: $$\binom{n-1}{k-1}\binom{n}{k+1}\binom{n+1}{k}=\binom{n-1}{k}\binom{n}{k+1}\binom{n+1}{k+1}$$
