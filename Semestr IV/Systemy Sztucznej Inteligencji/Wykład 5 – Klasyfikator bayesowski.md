...
Prawdopodobieństwo warunkowe mówi nam jaką decyzję podejmiemy znając określone informacje: $$P(h_{n} \mid D)=\frac{P(h_{n})\cdot P(D \mid h_{n})}{\sum_{i} P(h_{i})\cdot P(D\mid h_{i})}$$
