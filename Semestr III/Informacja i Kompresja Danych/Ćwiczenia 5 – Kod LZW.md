...
Chcąc zakodować komunikat $\vec{m} = m_1 \dots m_k \in \mathcal{A}^*$, wpisujemy do słownika $S$ wszystkie litery alfabetu $\mathcal{A} = \{a_1, \dots, a_n\}$ o indeksach $1, \dots, n$.
