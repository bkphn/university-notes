...
2. **Szyfrowanie wiadomości:** Chcąc zaszyfrować komunikat $\vec{m}$, wybieramy losowe $x \in (1, p-1)$ i wyznaczamy dwie liczby $c_1, c_2$:   $$c_1 = g^x \pmod p, \quad c_2 = \vec{m} \cdot y^x \pmod p$$Para $(c_1, c_2)$ jest naszym szyfrogramem.
