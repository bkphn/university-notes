...
* **Algorytm częściowo poprawny** spełnia założenie:

$$\forall_{i \in I} \exists_{o \in O} : A\vert{}i \Rightarrow f(i) = o$$

* **Algorytm poprawny** jest częściowo poprawny i oprócz tego spełnia własność stopu:

$$\forall_{i \in I} A\vert{}i$$
