...
Na początek tworzymy zbiory $S=\emptyset$,  $Q=V$. Koszt $d$ wierzchołka startowego $v_0$ ustalamy na $0$: $$d(v_0 )=0$$Koszt wszystkich pozostałych wierzchołków ustalamy na $∞$. Poprzednik wierzchołków $v_i$  definiujemy jako $p(v_i$) i na początku ustawiamy im wartość `None`.
