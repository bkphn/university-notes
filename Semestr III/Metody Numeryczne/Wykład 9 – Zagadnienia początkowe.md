...
$$\Delta(x,y,h,f)=\begin{cases} \frac{z(x+h)-y}{h}, \quad h\neq 0  \\ f(x,y), \quad h=0\end{cases}$$

przedstawia iloraz różnicowy rozwiązania dokładnego $z(t)$ zagadnienia początkowego dla kroku $h$. Funkcja $\Phi=\Phi(x,y,h,f)$ jest ilorazem różnicowym dla rozwiązania przybliżonego $\eta$ dla kroku $h$.
